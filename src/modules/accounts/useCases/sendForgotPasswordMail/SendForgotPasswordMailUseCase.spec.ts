...
describe("Send Forgot Mail", () => {
  beforeEach(() => {
    ...
    usersTokensRepositoriesInMemory = new UsersTokensRepositoryInMemory();
    mailProvider = new MailProviderInMemory();

    sendForgotPasswordMailUseCase = new SendForgotPasswordMailUseCase(
      usersRepositoryInMemory,
      usersTokensRepositoriesInMemory,
      dateProvider,
      mailProvider
    );
  });
  ...
  it("should be able to create an users token", async () => {
    const generateTokenMail = spyOn(usersTokensRepositoriesInMemory, "create");
